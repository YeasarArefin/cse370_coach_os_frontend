        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3.5 right-3.5 size-8 rounded-full text-muted-foreground hover:text-foreground hover:bg-muted"
                size="icon"
              />
            }
          >
